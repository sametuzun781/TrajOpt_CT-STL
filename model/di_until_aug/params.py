...
def params_fcn( 
    ...
    x_init = np.hstack(([-6.0,  0.0, 0.0], np.zeros(n_x - 3)))
    ...
    return {
        ...
        "f_dt_dim":  1,
        "w_dt_fcn":  [1.0],
        "pen_dt_fcn": [penalty_fcn_list[1]],   # or whatever penalty list index you want
        "name_dt_fcn": [['evnt_vst_1', 'none'][0]],  # must match the shape your solver expects
