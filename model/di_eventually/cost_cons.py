...
def cvx_cons_fcn(
    ...
    vehicle_cons += [
        ...
        X[6,  0] == 1.0, # geometric integral
        X[8,  0] == 1.0, # geometric integral
        X[10,  0] == 1.0, # geometric integral
...
def ncvx_dt_fcn(
    ...
    cc = 1e-2
    z1 += -((cc + 5*X_last[7, -1])**(1/2) - (cc + (0.1*X_last[6, -1]))**(1/2) )
    z2 += -((cc + 5*X_last[9, -1])**(1/2) - (cc + (0.1*X_last[8, -1]))**(1/2) )
    z3 += -((cc + 5*X_last[11, -1])**(1/2) - (cc + (0.1*X_last[10, -1]))**(1/2) )

    return jnp.atleast_1d([z1, z2, z3]) 
